...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_Macro.git', :tag => s.version.to_s }
...
#====================================================================
# 'h,m' 之间不能有空格
s.source_files = 'HR_Macro/Classes/**/*.{h,m}'


# 3.3:资源文件
#====================================================================
# 'HR_Macro' 为存储的 bundleName
#s.resource_bundles = {
#    'HR_Macro' => ['HR_Macro/**/*.{storyboard,xib,png,plist}']
#}
